...
# test performance 
```{r test}
glm.pred <- predict(model.glm, newdata = xy_train, type = "prob")[,2]
glmn.pred <- predict(model.glmn, newdata = xy_train, type = "prob")[,2]

roc.glm <- roc(data_train$disease, glm.pred)
roc.glmn <- roc(data_train$disease, glmn.pred)
## look at sen and sel
