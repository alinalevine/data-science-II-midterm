...
#k
#100 496
mean(model.knn1$results$Accuracy)
mean(model.knn1$results$Kappa)
```
...
test.pred.knn[knn.pred>0.05] <- "pos"
...
res1 = resamples(list(NB1 = model.nb1, KNN1 = model.knn1))
summary(res1)
```
